...
fd-receive, mount topology with unmatched-target checks, split metadata/xattr, and filesystem-socket IPC operation rules, regular-file write opens, `write(2)`, `writev(2)`,
...
fs/namei.c, fs/open.c, fs/read_write.c, fs/attr.c, fs/xattr.c, fs/stat.c, fs/readdir.c, fs/fhandle.c, fs/namespace.c, net/unix/af_unix.c, security/security.c:
  ...
  fd-receive, mount topology with unmatched-target checks, split metadata/xattr, and filesystem-socket IPC operation tree, and recursive
